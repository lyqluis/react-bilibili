import{a as s,j as e,S as a,s as t,L as i,u as r,b as n,c as o,d as l,e as c,f as d,I as h,g as m,r as u,h as g,i as p,k as f,l as j,p as x,m as w}from"./index-b58dd535.js";import{S as y,a as k,b as v}from"./SearchHistory-afd16c7b.js";import{S}from"./Section-b6a3a8d2.js";import{L as C}from"./index-dc19943f.js";import{L as N}from"./ListCard-e5835cc4.js";import{u as b}from"./useRequest-e96b32f6.js";import"./input-414b791f.js";import"./bound-6644a254.js";const z=()=>s({method:"get",url:"/hotsearchkeyword"}).catch((s=>{})),R=()=>s({method:"get",url:"/searchplaceholder"}).catch((s=>{}));function L({list:s=[],onSelect:t,loading:i}){if(i){const s=new Array(10).fill(null).map(((s,t)=>e.jsx(a,{animated:!0,className:"skeleton"},t)));return e.jsx(I,{className:"hot-search-list",children:s})}return e.jsx(I,{className:"hot-search-list",children:s.map((s=>e.jsxs("p",{className:"ellipsis-line-1",onClick:()=>t(s.keyword),children:[e.jsx("span",{className:"num",children:s.id}),e.jsx("span",{className:"word ellipsis-line-1",children:s.keyword}),e.jsx("i",{children:s.icon&&e.jsx("img",{src:s.icon,alt:s.keyword})})]},s.id)))})}const I=t.div`
	&.hot-search-list {
		display: grid;
