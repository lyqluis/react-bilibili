import{a as s,j as e,S as a,s as t,L as i,u as r,b as n,c as o,d as l,e as c,f as d,I as h,g as m,r as u,h as g,i as p,k as f,l as j,p as x,m as w}from"./index-5222d580.js";import{S as y,a as k,b as v}from"./SearchHistory-3a2ab7d8.js";import{S}from"./Section-cfccf90d.js";import{L as C}from"./index-fc3d5f27.js";import{L as N}from"./ListCard-4b3d2f60.js";import{u as b}from"./useRequest-e96b32f6.js";import"./input-b261d64e.js";import"./bound-6644a254.js";const z=()=>s({method:"get",url:"/hotsearchkeyword"}).catch((s=>{})),R=()=>s({method:"get",url:"/searchplaceholder"}).catch((s=>{}));function L({list:s=[],onSelect:t,loading:i}){if(i){const s=new Array(10).fill(null).map(((s,t)=>e.jsx(a,{animated:!0,className:"skeleton"},t)));return e.jsx(I,{className:"hot-search-list",children:s})}return e.jsx(I,{className:"hot-search-list",children:s.map((s=>e.jsxs("p",{className:"ellipsis-line-1",onClick:()=>t(s.keyword),children:[e.jsx("span",{className:"num",children:s.id}),e.jsx("span",{className:"word ellipsis-line-1",children:s.keyword}),e.jsx("i",{children:s.icon&&e.jsx("img",{src:s.icon,alt:s.keyword})})]},s.id)))})}const I=t.div`
	&.hot-search-list {
		display: grid;
